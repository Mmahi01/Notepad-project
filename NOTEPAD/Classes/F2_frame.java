...
public class F2_frame extends JFrame { 								
    ...
    private void initializeUI() {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int result = fileChooser.showSaveDialog(F2_frame.this);              // Show the file chooser dialog
                ...
                if (result == JFileChooser.APPROVE_OPTION) {                         // If a file is selected
                    try {
                        ...
                        JOptionPane.showMessageDialog(F2_frame.this, "File saved successfully!"); // Show success message
                    } catch (IOException ex) {
                        ex.printStackTrace();
                        JOptionPane.showMessageDialog(F2_frame.this, "Error saving file!", "Error", JOptionPane.ERROR_MESSAGE); // Show error message
                    }
                }
            }
        });
